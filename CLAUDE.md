...
### PRIORITY 1 — Add collision-aware coordinate assignment for new locations
...
### PRIORITY 2 — Broadcast location_discovered from world_expansion.py
...
### PRIORITY 3 — Expand discovery detection to multiple signal sources
...
### PRIORITY 4 — Tie discovery to discoverer character state
...
### PRIORITY 5 — Increment use_count on Location when used in a scene
...
### PRIORITY 6 — Expose discovery history and evolution indicators on the dashboard
